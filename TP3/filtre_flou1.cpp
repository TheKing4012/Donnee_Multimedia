...
int process(OCTET *ImgIn, int x, int y, int nW) {
    return (ImgIn[x * nW + y] + ImgIn[(x-1) * nW + y] + ImgIn[(x+1) * nW + y] + ImgIn[x * nW + (y-1)] + ImgIn[x * nW + (y+1)]) / 5.0;
}

int process(OCTET *ImgIn, int x, int y, int nW) {
    return (ImgIn[x * nW + y] + ImgIn[(x-1) * nW + y] + ImgIn[(x+1) * nW + y] + ImgIn[(x+1) * nW + (y+1)] + ImgIn[(x+1) * nW + (y-1)] + ImgIn[(x-1) * nW + (y-1)] + ImgIn[(x-1) * nW + (y+1)]   + ImgIn[x * nW + (y-1)] + ImgIn[x * nW + (y+1)]) / 8.0;
}
